...
import com.joyrill.app.service.BridgeService;
import com.joyrill.app.service.BridgeService.IpcamClientInterface;
import com.joyrill.app.service.BridgeService.PlayInterface;
import com.joyrill.app.ui.base.BaseActivity;
import com.joyrill.app.util.AudioPlayer;
import com.joyrill.app.util.ContentCommon;
import com.joyrill.app.util.CustomBuffer;
import com.joyrill.app.util.CustomBufferData;
import com.joyrill.app.util.CustomBufferHead;
import com.joyrill.app.util.MonitorList;
import com.joyrill.app.util.MyRender;
import com.joyrill.app.util.SystemValue;

public class MonitorActivity extends BaseActivity implements OnTouchListener,
		OnGestureListener, OnClickListener, PlayInterface , IpcamClientInterface {
	...
	private ListView addr = null;
	List<MonitorList> monitorList;
	...
	private Handler PPPPMsgHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 1004:
				Toast.makeText(MonitorActivity.this, "相机断线", 0).show();
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if (!bProgress) {
				...
				if (timeTag == 0) {
					...
					timeTag = 1;
					Toast.makeText(MonitorActivity.this, R.string.main_show_back,
							0).show();
				} else if (timeTag == 1) {
	...
	private void showToast(int i) {
		Toast.makeText(MonitorActivity.this, i, 0).show();
...
//				playSurface.setBackgroundDrawable(drawable);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		monitorList =new ArrayList<MonitorList>();
		monitorList.add(new MonitorList("admin", "888888", "VSTC051302WMHKD"));
		monitorList.add(new MonitorList("admin", "888888", "VSTC058368WPPKT"));
		monitorList.add(new MonitorList("admin", "888888", "VSTC058353XWLEE"));
		monitorList.add(new MonitorList("admin", "888888", "VSTC058366MVZBV"));
		...
		String [] address = this.getResources().getStringArray(R.array.monitor_address);
		ArrayAdapter<String> addressAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_expandable_list_item_1,address);
		...
		addr.setAdapter(addressAdapter);
		...
		MonitorActivity.this.registerReceiver(brodCast, filter);
	}
	...
	private void findView() {
		addr = (ListView)findViewById(R.id.monitorAddress);
		...
		addr.setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				MonitorList monitor = monitorList.get(arg2);
				
				SystemValue.deviceId = monitor.getDeviceId();
				SystemValue.deviceName = monitor.getDeviceName();
				SystemValue.devicePass = monitor.getDevicePass();
				if(strDID!=null){
	...
	public void callBackCameraParamNotify(String did, int resolution,
		...
		Logger.d("callBackCameraParamNotify");
...
//				takePicture(mBmp);
	...
	public void callBackMessageNotify(String did, int msgType, int param) {
		Log.d("tag", "MessageNotify did: " + did + " msgType: " + msgType
				+ " param: " + param);
		Logger.d("callBackMessageNotify");
		if (bManualExit)
			return;
