...
import com.joyrill.app.operation.AreaOperation;
...
public class AreaActivity extends BaseActivity implements OnClickListener,
	...
	private LinearLayout areaView, deviceViewLeft, deviceViewRight;
	...
	private AreaReceiver receiver = null;
	...
	private void addAreas() {
		...
		areaView = (LinearLayout) this.findViewById(R.id.area);
		areas = AreaOperation.findAllArea();
		for (Area area : areas) {
			MyImageButton button = new MyImageButton(this);
			button.setBackgroundResource(area.getImgIco());
			button.setText(area.getAreaName());
			button.setOnClickListener(uiHandler, area.getAreaId());
			/*
			 * TextView textView = new TextView(this);
			 * textView.setText(area.getAreaName()); Drawable drawable =
			 * ImageScale.getImageFromAssetsFile(area.getImgIco());
			 * textView.setGravity(Gravity.CENTER); textView.setPadding(10, 0,
			 * 10, 0); textView.setCompoundDrawablesWithIntrinsicBounds(null,
			 * drawable, null, null); textView.setId(area.getAreaId());
	...
	private void addDevices(Message msg) {
		...
		int areaId = msg.arg1;
		devices = DeviceOperation.findDeviceByAreaId(areaId);
		areaController.findDeviceStateByAreaId(areaId);
		int i = 1;
	...
	private void addDeviceItem(Device device, int i) {
		...
		case 11: {
			 ...
			 * DeviceTypeLightGupLightTwoWay( this);
		...
		case 13: {
/*			DeviceTypeDimmerGupDimmerOneWay dimmerOneWay = new DeviceTypeDimmerGupDimmerOneWay(
					this);
		...
		case 14: {
/*			DeviceTypeDimmerGupDimmerTwoWay dimmerTwoWay = new DeviceTypeDimmerGupDimmerTwoWay(
					this);
		...
		case 15: {
/*			DeviceTypeDimmerGupDimmerColorTwoWay dimmerColorTwoWay = new DeviceTypeDimmerGupDimmerColorTwoWay(
					this);
			...
			dimmerColorTwoWay.setOnClickListener(device, areaController);
			baseAdjust.put(device.getDeviceId(), dimmerColorTwoWay);
			if ((i & 1) != 0) {
	...
	class AreaReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			Logger.d("area receive broadcast");
