...
public class DeviceTypeCurtainGupCurtainInsideTwoWay extends LinearLayout {
	private View v;
	private TextView title, status;
	private ImageView image;

	public DeviceTypeCurtainGupCurtainInsideTwoWay(Context context) {
		this(context, null);
	}
	...
	public DeviceTypeCurtainGupCurtainInsideTwoWay(Context context,
		...
		title = (TextView) v.findViewById(R.id.curtaininsidetwowayTitle);
		image = (ImageView) v.findViewById(R.id.curtaininsidetwowayImage);
		status = (TextView) v.findViewById(R.id.curtaininsidetwowayStatus);
	}
