...
public class DeviceTypeSocketGupSocketOneWay extends LinearLayout {
	private View v;
	...
	public DeviceTypeSocketGupSocketOneWay(Context context){
		this(context , null);
	}
	
	public DeviceTypeSocketGupSocketOneWay(Context context, AttributeSet attrs){
		super(context , attrs);
		v = LayoutInflater.from(context).inflate(R.layout.devicetype_socketgup_socketoneway, this, true);
		title = (TextView)v.findViewById(R.id.socketonewayTitle);
		image = (ImageView)v.findViewById(R.id.socketonewayImage);
		turnOn = (Button)v.findViewById(R.id.socketonewayButtonOpen);
		turnClose = (Button)v.findViewById(R.id.socketonewayButtonStop);
	}
