...
public class DeviceTypeDimmerGupDimmerTwoWay extends LinearLayout {
	private View v;
	...
	public DeviceTypeDimmerGupDimmerTwoWay(Context context){
		this(context , null);
	}
	
	public DeviceTypeDimmerGupDimmerTwoWay(Context context, AttributeSet attrs){
		super(context , attrs);
		v = LayoutInflater.from(context).inflate(R.layout.devicetype_dimmergup_dimmertwoway, this, true);
		title = (TextView)v.findViewById(R.id.dimmertwowayTitle);
		image = (ImageView)v.findViewById(R.id.dimmertwowayImage);
		statusBar = (SeekBar)v.findViewById(R.id.dimmertwowayStatusBar);
		status = (TextView)v.findViewById(R.id.dimmertwowayStatus);
	}
